...
```
The Superior California region accounted for the lowest `median` full-time median weekly price for center-base childcare for infants in 2018. This does not correspond to the region with the lowest median household income in 2018, which was the North Coast region based on the table in the previous question.
...
# Source: https://scales.r-lib.org/reference/label_currency.html
# Improving the plot by adding $ to y-axis labels
...
# Source: https://thomasadventure.blog/posts/ggplot-regression-line/#:~:text=To%20make%20geom_smooth()%20draw,short%20for%20%E2%80%9Clinear%20model%E2%80%9D.&text=The%20gray%20shading%20around%20the,by%20changing%20the%20level%20parameter.
